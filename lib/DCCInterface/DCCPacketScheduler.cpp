...
// Revision History:
// ~~~~~~~~~~~~~~~~~
// 16.01.22:  Hardi: Added (uint8_t) to prevent compiler warning "warning: narrowing conversion of..."
...
bool DCCPacketScheduler::opsProgramCV(uint16_t address, uint16_t CV, uint8_t CV_data)
{
    ...
    uint8_t data[] = { (uint8_t)(((CV >> 8) & B11) | B11101100), (uint8_t)(CV & 0xFF), CV_data };             // 16.01.22:  Hardi: Added (uint8_t) to prevent compiler warning "warning: narrowing conversion of..."
...
bool DCCPacketScheduler::opsPOMwriteBit(uint16_t address, uint16_t CV, uint8_t Bit_data)
{
	...
	DCCPacket p(address);
	// split the CV address up among data uint8_ts 0 and 1
    uint8_t data[] = { (uint8_t)(((CV >> 8) & B11) | B11101000), (uint8_t)(CV & 0xFF), (uint8_t)(Bit_data & 0x0F)}; // 16.01.22:  Hardi: Added (uint8_t) to prevent compiler warning "warning: narrowing conversion of..."
...
bool DCCPacketScheduler::opsPOMreadCV(uint16_t address, uint16_t CV)
{
	...
	DCCPacket p(address);
	// split the CV address up among data uint8_ts 0 and 1
    uint8_t data[] = { (uint8_t)(((CV >> 8) & B11) | B11100100), (uint8_t)(CV & 0xFF), 0x00 };                // 16.01.22:  Hardi: Added (uint8_t) to prevent compiler warning "warning: narrowing conversion of..."
