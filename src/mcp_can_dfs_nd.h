...
#define MCP_RXB0CTRL    0x60      // 7654 3210 Bit Nr
#define MCP_RXB0SIDH    0x61      // 0110 0001
#define MCP_RXB1CTRL    0x70
#define MCP_RXB1SIDH    0x71      // 0111 0001
...
#define STATUS_LED_OFF 0x3C;       // 0x3C if the LED's are connected to 5V (recommended)                      // 23.10.17: Hardi
                                   // 0x0C if they are connected to GND
