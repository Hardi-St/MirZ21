...
#define MINIZ_NO_STDIO                                                                                        // 25.01.22:  Hardi

/* If MINIZ_NO_TIME is specified then the ZIP archive functions will not be able to get the current time, or */
/* get/set file times, and the C run-time funcs that get/set times won't be called. */
/* The current downside is the times written to your archives will be from 1979. */
#define MINIZ_NO_TIME                                                                                         // 25.01.22:  Hardi

/* Define MINIZ_NO_ARCHIVE_APIS to disable all ZIP archive API's. */
#define MINIZ_NO_ARCHIVE_APIS                                                                                 // 25.01.22:  Hardi

/* Define MINIZ_NO_ARCHIVE_WRITING_APIS to disable all writing related ZIP archive API's. */
#define MINIZ_NO_ARCHIVE_WRITING_APIS                                                                         // 25.01.22:  Hardi
...
#define TINFL_LZ_DICT_SIZE (32768/16)                                                                         // 26.01.22:  Org: 32768
