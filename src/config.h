...
#define WIFI  //WiFi Interface Ã¼ber Serial-Port fÃ¼r Arduino UNO/MEGA/DUE zum ESP 8266
...
//#define LAN       //LAN Ethernet Z21 LAN Kommunikation mit W5100 oder ENC28 Ethernet Shield. Bitte diese IP nur Ã¼ber die Webseite (http://192.168.0.111) Ã¤ndern! (not for ESP8266 and ESP32)
//#define ENC28     //USE a ENC28J60 module - instead of w5100 Shield (MEGA only!)
//#define LANmacB2 0xEF   //Byte2 (DEFAULT = 84:2B:BC:EF:FE:ED!) change optional LAN MAC Address. MAC starts with: â€ž84:2B:BC:..Byte*2..:..Byte*1..:..Byte*0..â€œ
...
//#define LnBufferUSB  //LocoNet LocoBuffer-USB at 57600 bps (Achtung: kein Debug Ã¼ber Serial Monitor mÃ¶glich!)                  // 17.01.22:  Disabled
